...
@implementation UIImageView (HitRect)
...
- (BOOL)pointInside:(CGPoint)point withEvent:(UIEvent *)event {
    //如果 imageView 边界值无变化、失效、隐藏、或者透明直接返回
    if (UIEdgeInsetsEqualToEdgeInsets(self.hitEdgeInsets, UIEdgeInsetsZero) || self.hidden || self.alpha == 0) {
